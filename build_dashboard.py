...
.topnav a{font-size:12.5px;font-weight:700;text-decoration:none;color:var(--accent);
...
<header><div class="head-in">
  ...
  <div class="tagline">上野2店・秋葉原2店・門前仲町2店／全台データ日次集計</div>
  <nav class="topnav">
    <a href="./gallery.html">🖼 機種別差枚(画像)</a>
    <a href="./monthly.html">📊 月間データ帳</a>
  </nav>
